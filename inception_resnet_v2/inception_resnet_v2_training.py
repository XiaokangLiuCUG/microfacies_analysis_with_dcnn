...
TRAIN_FILE = "D:/netslogs/inception_resnet_v2/save_model/"
VALIDATION_FILE = "D:/netslogs/inception_resnet_v2/validation_log/"
...
CKPT_FILE = "./inception_resnet_v2_2016_08_30.ckpt"
...
def main():
    ...
    with slim.arg_scope(inception_resnet_v2.inception_resnet_v2_arg_scope()):
        logits, _ = inception_resnet_v2.inception_resnet_v2(images, num_classes=N_CLASSES, is_training=is_training,dropout_keep_prob=keep_prob)
    ...
    # output = [g for g in g_list if 'output' in g.name]
