...
def read_TFRecord(data_dir, batch_size, shuffle, in_classes,IMG_HEIGHT,IMG_WIDTH, is_training):
    ...
    #image = inception_preprocessing.preprocess_for_train(image,IMG_HEIGHT,IMG_WIDTH,bbox=None,random_crop=False)
    image = inception_preprocessing.preprocess_image(image,IMG_HEIGHT,IMG_WIDTH,is_training)
